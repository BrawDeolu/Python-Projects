...
tip_percentage = int(input("How much tip would you like to give? This is already in percentage, please don't add any percentage sign: 10, 12 or 15 "))
...
# Response
print(f"Each person should pay ${final_amount}")# Greeting
print("Welcome to the tip calculator built with love by Moses")
